...
from algorithm.callbacks.callback_base import CallbackBase
from algorithm.feature.evaluation.performance_recorder import PerformanceRecorder
from algorithm.feature.instance import Instance
from algorithm.param.evaluation_param import EvaluateParam
from algorithm.transfer_variable.transfer_class.validation_strategy_transfer_variable import \
...
class ValidationStrategy(CallbackBase):
    ...
    def evaluate(self, predicts, model, epoch):
        ...
        from algorithm.feature.evaluation.evaluation import Evaluation
        eval_obj = Evaluation()
