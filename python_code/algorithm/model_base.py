...
from algorithm.callbacks.callback_list import CallbackList
from algorithm.feature.instance import Instance
from algorithm.param.evaluation_param import EvaluateParam
from algorithm.protobuf import deserialize_models
from algorithm.statistic.data_overview import header_alignment
from algorithm.util import LOGGER, abnormal_detection
from algorithm.util.component_properties import ComponentProperties, RunningFuncs
from algorithm.util.io_check import assert_match_id_consistent
...
class WarpedTrackerClient:
    ...
    def log_metric_data(
        ...
        return self._tracker.save_metric_data(
    ...
    def set_metric_meta(
        ...
        return self._tracker.save_metric_meta(
            metric_namespace=metric_namespace,
            metric_name=metric_name,
    ...
    def log_component_summary(self, summary_data: dict):
        return self._tracker.insert_summary_into_db(summary_data=summary_data)
