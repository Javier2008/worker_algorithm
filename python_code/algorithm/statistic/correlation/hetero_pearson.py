...
from algorithm.secureprotol.spdz.tensor.fixedpoint_table import (
    FixedPointTensor,
    table_dot,
)
...
class HeteroPearson(ModelBase):
    ...
    def _get_meta(self):
        from algorithm.protobuf.generated import pearson_model_meta_pb2
    ...
    def _get_param(self):
        from algorithm.protobuf.generated import pearson_model_param_pb2
