...
def hetero_feature_binning_param():
    from algorithm.param.feature_binning_param import HeteroFeatureBinningParam
...
def hetero_feature_binning_guest_runner():
    from algorithm.feature.hetero_feature_binning.hetero_binning_guest import (
...
def hetero_feature_binning_host_runner():
    from algorithm.feature.hetero_feature_binning import (
