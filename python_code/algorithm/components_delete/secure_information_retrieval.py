...
def secure_information_retrieval_guest_runner():
    from algorithm.secure_information_retrieval.secure_information_retrieval_guest import (
...
def secure_information_retrieval_host_runner():
    from algorithm.secure_information_retrieval.secure_information_retrieval_host import (
