...
def hetero_poisson_runner_guest():
    from algorithm.feature.linear_model.coordinated_linear_model.poisson_regression.hetero_poisson_regression.hetero_poisson_guest import (
        HeteroPoissonGuest, )
...
def hetero_poisson_runner_host():
    from algorithm.feature.linear_model.coordinated_linear_model.poisson_regression.hetero_poisson_regression.hetero_poisson_host import (
        HeteroPoissonHost, )
...
def hetero_poisson_runner_arbiter():
    from algorithm.feature.linear_model.coordinated_linear_model.poisson_regression.hetero_poisson_regression.hetero_poisson_arbiter import (
