...
def hetero_sshe_lr_runner_guest():
    from algorithm.feature.linear_model.bilateral_linear_model.hetero_sshe_logistic_regression.hetero_lr_guest import (
        HeteroLRGuest,
    )
...
def hetero_sshe_lr_runner_host():
    from algorithm.feature.linear_model.bilateral_linear_model.hetero_sshe_logistic_regression.hetero_lr_host import (
        HeteroLRHost,
    )
