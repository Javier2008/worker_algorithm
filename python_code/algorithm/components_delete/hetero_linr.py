...
def hetero_linr_runner_guest():
    from algorithm.feature.linear_model.coordinated_linear_model.linear_regression.hetero_linear_regression.hetero_linr_guest import (
        HeteroLinRGuest, )
...
def hetero_linr_runner_host():
    from algorithm.feature.linear_model.coordinated_linear_model.linear_regression.hetero_linear_regression.hetero_linr_host import (
        HeteroLinRHost, )
...
def hetero_linr_runner_arbiter():
    from algorithm.feature.linear_model.coordinated_linear_model.linear_regression.hetero_linear_regression.hetero_linr_arbiter import (
        HeteroLinRArbiter, )
