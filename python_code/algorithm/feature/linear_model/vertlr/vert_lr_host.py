...
class VertLRHost(VertLRBaseModel):
    def __init__(self):
        super().__init__()
        self.batch_num = None
    ...
    def fit_binary(self, data_instances, validate_data):
        ...
        print(self.cipher_operator.public_key.g)
        ...
        self.gradient_loss_operator.remote_provider_weight((self.model_weights,  self.header))
    ...
    def predict(self, data_instances):
        ...
        self.transfer_variable.host_prob.remote(prob_provider, role=consts.GUEST, idx=0)
