...
from algorithm.framework.weights import OrderDictWeights, Weights
from algorithm.feature.nn.backend.tf_keras import losses
from algorithm.feature.nn.homo_nn.nn_model import DataConverter, NNModel
...
class KerasNNModel(NNModel):
    ...
    def get_forward_loss_from_input(self, X, y):
        from algorithm.feature.nn.hetero_nn.backend.tf_keras import losses
    ...
    def restore_model(
        ...
        try:
            ...
            # add custom objects
            from algorithm.feature.nn.hetero_nn.backend.tf_keras.losses import (
                keep_predict_loss,
            )
