...
from algorithm.feature.nn.homo_nn._consts import _build_model_dict
from algorithm.feature.nn.homo_nn.nn_model import restore_nn_model
from algorithm.framework.homo.blocks import (
    secure_mean_aggregator,
    loss_scatter,
    has_converged,
)
from algorithm.model_base import MetricMeta, Metric
from algorithm.optim.convergence import converge_func_factory
from algorithm.util import LOGGER
from algorithm.util.homo_label_encoder import (
...
def client_get_param(self):
    from algorithm.protobuf.generated import nn_model_param_pb2
