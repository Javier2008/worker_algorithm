...
#
from algorithm.feature.nn.homo_nn._consts import _extract_meta, _extract_param
...
from algorithm.framework.homo.blocks.secure_aggregator import SecureAggregatorTransVar
from algorithm.model_base import Metric, MetricMeta
...
from common.computing import is_table
...
class HomoNNServer(HomoNNBase):
    ...
    def _init_model(self, param: HomoNNParam):
        ...
        if self.is_version_0():
            from algorithm.feature.nn.homo_nn import _version_0
    ...
    def fit(self, data_inst):
        ...
        if self.is_version_0():
            ...
            from algorithm.feature.nn.homo_nn._torch import build_aggregator
...
class HomoNNClient(HomoNNBase):
    ...
    def fit(self, data, *args):
        ...
        if self.is_version_0():
            ...
            from algorithm.feature.nn.homo_nn._torch import build_trainer
    ...
    def predict(self, data):
        ...
        if self.is_version_0():
            ...
            from algorithm.feature.nn.homo_nn._torch import make_predict_dataset
    ...
    def load_model(self, model_dict):
        ...
        if self.is_version_0():
            ...
            from algorithm.feature.nn.homo_nn._torch import PyTorchFederatedTrainer
