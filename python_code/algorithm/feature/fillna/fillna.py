...
from algorithm.feature.fillna.fillna_param import FillNaParam
from algorithm.feature.imputer import Imputer
from algorithm.model_base import ModelBase
from algorithm.protobuf.generated.feature_imputation_meta_pb2 import FeatureImputationMeta, FeatureImputerMeta
from algorithm.protobuf.generated.feature_imputation_param_pb2 import FeatureImputationParam
...
class FillNa(ModelBase):
    def __init__(self):
        ...
        self.header = None
        self.model_param = FillNaParam()
        
        self.model_param_name = 'FeatureImputationParam'
        self.model_meta_name = 'FeatureImputationMeta'
    
    def _init_model(self, model_param):
        self.missing_fill_method = model_param.fill_method
        self.col_missing_fill_method = model_param.col_fill_method
        self.default_value = model_param.default_value
        self.missing_impute = model_param.missing_impute #那些值定义为缺失值
...
def save_feature_imputer_model(missing_fill=False,
    ...
    model_param = FeatureImputationParam()
