...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.inference = channel.unary_unary(
                '/com.tsingj.me.api.serving.InferenceService/inference',
        ...
        self.startInferenceJob = channel.unary_unary(
                '/com.tsingj.me.api.serving.InferenceService/startInferenceJob',
                request_serializer=inference__service__pb2.InferenceMessage.SerializeToString,
                response_deserializer=inference__service__pb2.InferenceMessage.FromString,
                )
        self.getInferenceResult = channel.unary_unary(
                '/com.tsingj.me.api.serving.InferenceService/getInferenceResult',
                request_serializer=inference__service__pb2.InferenceMessage.SerializeToString,
                response_deserializer=inference__service__pb2.InferenceMessage.FromString,
                )
...
def add_InferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.tsingj.me.api.serving.InferenceService', rpc_method_handlers)
...
class InferenceService(object):
    ...
    def inference(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.serving.InferenceService/inference',
    ...
    def startInferenceJob(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.serving.InferenceService/startInferenceJob',
            inference__service__pb2.InferenceMessage.SerializeToString,
            inference__service__pb2.InferenceMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getInferenceResult(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.serving.InferenceService/getInferenceResult',
            inference__service__pb2.InferenceMessage.SerializeToString,
            inference__service__pb2.InferenceMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
