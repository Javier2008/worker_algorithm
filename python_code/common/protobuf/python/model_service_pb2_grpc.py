...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.publishLoad = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/publishLoad',
        ...
        self.publishBind = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/publishBind',
                request_serializer=model__service__pb2.PublishRequest.SerializeToString,
                response_deserializer=model__service__pb2.PublishResponse.FromString,
                )
        self.publishOnline = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/publishOnline',
                request_serializer=model__service__pb2.PublishRequest.SerializeToString,
                response_deserializer=model__service__pb2.PublishResponse.FromString,
                )
        self.queryModel = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/queryModel',
        ...
        self.unload = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/unload',
        ...
        self.unbind = channel.unary_unary(
                '/com.tsingj.me.api.mlmodel.manager.ModelService/unbind',
...
def add_ModelServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.tsingj.me.api.mlmodel.manager.ModelService', rpc_method_handlers)
...
class ModelService(object):
    ...
    def publishLoad(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/publishLoad',
    ...
    def publishBind(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/publishBind',
            model__service__pb2.PublishRequest.SerializeToString,
            model__service__pb2.PublishResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def publishOnline(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/publishOnline',
            model__service__pb2.PublishRequest.SerializeToString,
            model__service__pb2.PublishResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def queryModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/queryModel',
    ...
    def unload(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/unload',
    ...
    def unbind(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tsingj.me.api.mlmodel.manager.ModelService/unbind',
