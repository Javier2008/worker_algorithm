...
from common.common.address import HiveAddress
from common.storage import StorageSessionBase, StorageEngine, HiveStoreType
...
class StorageSession(StorageSessionBase):
    ...
    def table(self, name, namespace, address: AddressABC, partitions,
        ...
        if isinstance(address, HiveAddress):
            from common.storage.hive._table import StorageTable
