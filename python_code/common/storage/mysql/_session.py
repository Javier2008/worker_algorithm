...
from common.common.address import MysqlAddress
from common.storage import StorageSessionBase, StorageEngine, MySQLStoreType
...
class StorageSession(StorageSessionBase):
    ...
    def table(self, name, namespace, address: AddressABC, partitions,
        ...
        if isinstance(address, MysqlAddress):
            from common.storage.mysql._table import StorageTable
