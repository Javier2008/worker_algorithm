...
from common.common import log, hdfs_utils, hive_utils, conf_utils
from common.common.file_utils import get_project_base_directory
from common.common.profile import computing_profile
from common.computing._type import ComputingEngine
from common.computing.spark._materialize import materialize, unmaterialize
...
def from_localfs(paths: str, partitions, in_serialized=True, id_delimiter=None):
    ...
    from pyspark import SparkContext
    #conf = get_spark_conf()
    #conf.setExecutorEnv('PYTHONPATH','/home/tsingj_ubuntu/yuyunfu/pythonwork/python_code')
    sc = SparkContext.getOrCreate()
