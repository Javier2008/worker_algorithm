...
from common.federation.rabbitmq._mq_channel import MQChannel
from common.federation.rabbitmq._rabbit_manager import RabbitManager
...
class Federation(FederationABC):
    ...
    def remote(
        ...
        if _name_dtype_keys[0] not in self._name_dtype_map:
            ...
            if isinstance(v, Table):
                body = {"dtype": FederationDataType.STABLE, "partitions": v.partitions}
            else:
